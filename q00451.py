...
class Solution:
    ...
    def frequencySort(self, s: str) -> str:
        """
        One-liner solution using `collections.Counter`. Because of sorting, O(n log n).
        """
        # Get `Counter()` of character frequencies, sort descending by frequency, then join frequency-length runs of each character
